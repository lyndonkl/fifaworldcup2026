...
- **S17 · The number.** Ceremony exception, fully centered. Population dims to 15%; final's dots form the underline at 60% amber. Hero price in white Inter 600 tabular; devig line beneath in 24px amber, same freeze/timestamp. Nothing moves last except the population settling.
